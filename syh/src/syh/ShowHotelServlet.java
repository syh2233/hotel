    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                hotel.put("hotel_addr", resultSet.getString("hotel_addr"));
                hotel.put("hotel_phone", resultSet.getString("hotel_phone"));
                hotelList.add(hotel);
            }
            ...
            e.printStackTrace();
            response.sendRedirect("ShowHotel.jsp?error=true");
        } finally {
